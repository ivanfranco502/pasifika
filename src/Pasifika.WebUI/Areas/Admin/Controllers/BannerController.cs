...
namespace Pasifika.WebUI.Areas.Admin.Controllers
{
    ...
    public class BannerController : Controller
    {
        ...
        public ActionResult Edit(int id, string returnUrl)
        {
            ...
            return View(new ViewModels.BannerEditViewModel
            {
                Pagina = p
            });
        }
        ...
        {
            List<Banner> b = JsonConvert.DeserializeObject<List<Banner>>(txtJsonBanners);

            int posFileBanner = 0;
            foreach (Banner banner in b)
            {
            ...
            _pagina.GuardarBanners(Id, b, Server.MapPath("~/Content/"));
