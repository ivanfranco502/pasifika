...
namespace Pasifika.WebUI.DI.Ninject.Modules
{
        ...
        : NinjectModule
    {
        public override void Load()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "Pasifika.WebUI" };
...
// Setup cache
            ...
            this.Kernel.Bind<ICacheDependency>().To<NullCacheDependency>().Named("cacheDependency1");
...
// Prepare for our node providers
            ...
            this.Kernel.Bind<IReservedAttributeNameProvider>().To<MyReservedAttributeNameProvider>()
