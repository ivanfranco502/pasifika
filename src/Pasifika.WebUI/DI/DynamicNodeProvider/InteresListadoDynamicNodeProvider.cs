...
{
    public class InteresListadoDynamicNodeProvider : DynamicNodeProviderBase
    {
        private readonly ITagBusiness _tag;
        public InteresListadoDynamicNodeProvider(ITagBusiness t)
        {
            this._tag = t;
        }
        ...
        public override IEnumerable<DynamicNode> GetDynamicNodeCollection(ISiteMapNode node)
        {
            ...
            foreach (var t in lst)
            {
                ...
                dynamicNode.Title = t.Descripcion;
                //dynamicNode.ParentKey = "InteresTag_" + t.Id;
                dynamicNode.Key = "Tag_" + t.Id;
